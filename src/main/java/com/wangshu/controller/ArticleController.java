...
import com.wangshu.entity.User;
...
import com.wangshu.utils.ConstantFinal;
...
public class ArticleController {
	...
	public String checkList(HttpServletRequest request,
		...
		String pageString = PageUtil.page(arPage.getPageNum(), arPage.getPages(), "/article/checkList", arPage.getPageSize());
		request.setAttribute("pageStr", pageString);
